...
const Sidebar = () => {
  return (
    <div className='flex flex-col justify-between w-16 h-screen bg-gray-800 border-r border-gray-700'>
      <div>
        <Link href='/'>
          <a className='inline-flex items-center justify-center w-16 h-16'>
            <span className='w-10 h-10 bg-gray-200 rounded-lg grid place-items-center font-bold italic leading-none text-white bg-gradient-to-r from-green-300 via-blue-500 to-purple-600'>
              P
            </span>
          </a>
        </Link>
